...
public class Main {
    public static void main(String[] args) {
        ...
        Reunion reunion = new ReunionPresencial("sala1", leo, "2025-05-21T14:30", 45);
        reunion.iniciar();

        Empleado rafa = new Empleado("Rafa", "Ortega", "222", "leoth159@gmal.com", "informatica");
        Empleado martin = new Empleado ("Martin", "Henriquez", "202", "martin@gmal.com", "informatica");
        Empleado maria = new Empleado("Maria", "Juana", "153", "maria159@gmal.com", "informatica");
